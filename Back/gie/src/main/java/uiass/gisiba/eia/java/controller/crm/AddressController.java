...
/////////////////////////////////////////////////// Update METHOD //////////////////////////////////////////////////////////////////
    ...
    public static void updateAddressController() {
        ...
        public String handle(Request request, Response response)  {
            ...
            List addressValues = ContactParser.addressValuesCollector(gson, body);

            // We select only the non null values with their corresponding columns and form the update map :
            Map<String, Object> address_new_values = Parser.mapFormater(ContactParser.address_columns, addressValues);
